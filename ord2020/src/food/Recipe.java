...
public class Recipe {
    ...
    public Recipe createNPortions(int n) {
        var scale = (double) n / nPortions;
        return new Recipe(name, category, n, ingredients.scaleIngredients(scale));
    }

    public Recipe createNPortionsUsingDelegation(int n) {
        var scale = (double) n / nPortions;
        return new Recipe(name, category, n, new ScaledIngredients(ingredients, scale));
    }
